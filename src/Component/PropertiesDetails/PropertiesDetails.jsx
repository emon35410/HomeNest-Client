...
const PropertiesDetails = () => {
    ...
    const loadReviews = () => {
        fetch(`http://localhost:3000/reviews?property_id=${home._id}`)
            .then((res) => res.json())
    ...
    return (
        <div className="max-w-6xl mx-auto px-6 py-10">
            ...
            <div className="mt-8 grid md:grid-cols-3 gap-8">
                ...
                >
                    ...
                    <div className="flex flex-col items-center text-center">
                        ...
                        />
                        <h3 className="text-lg text-gray-800 font-bold mt-3">
                            {home.seller_name}
                        </h3>
            ...
            <div className="mt-12 border-t pt-8">
                ...
                {/* Display Reviews */}
                <div className="mt-8">
                    <h3 className="text-2xl font-semibold mb-4">What Others Say</h3>
                    {reviews.length > 0 ? (
                        reviews.map((r, index) => (
                            <div
                                key={index}
